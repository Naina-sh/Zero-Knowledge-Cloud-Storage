      ...
      >
        ...
        <div className="glass-card p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Sign in to {APP_NAME}</p>
          </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-4">
          🔒 Your password is used to derive encryption keys locally. The server never sees it.
        </p>
      </motion.div>
    </div>
  );
